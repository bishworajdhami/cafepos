                    ...
                    <div className="sdp-body">
                                    ...
                                    {batchesLoading ? (
                                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                                            {Array.from({ length: 4 }).map((_, i) => (
                                                <div key={i} style={{ padding: '1rem', border: '1px solid var(--color-border)', borderRadius: '10px', height: '100px' }}>
                                                    <span className="skel skel-md skel-w-3-4" />
                                                    <div style={{ marginTop: '0.75rem' }}><span className="skel skel-sm skel-w-half" /></div>
                                                    <div style={{ marginTop: '0.5rem' }}><span className="skel skel-xs skel-w-full" /></div>
                                                </div>
                                            ))}
                                        </div>
                                    ) : batches.length === 0 ? (
                        ...
                        {activeTab === 'history' && (
                            <div className="sdp-section-fade">
                                {historyLoading ? (
                                    <TableSkeleton cols={5} rows={6} compact />
                                ) : history.length === 0 ? (
